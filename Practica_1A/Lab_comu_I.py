...
# Title: tutorial de muestreo
# Author: Marcos_Arrieta_B1B_G5
...
class Lab_comu_I(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "tutorial de muestreo", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("tutorial de muestreo")
        ...
        self._samp_rate_range = qtgui.Range(1000, 80000, 1000, 10000, 200)
        ...
        self._freq_range = qtgui.Range(1000, 40000, 1000, 1000, 200)
